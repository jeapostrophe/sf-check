((Basics
 ...
 (Prop
  ((varieties_of_beauty 1 #f #t ())
   ...
   (foo 1 optional #t ())
   (|foo'| 1 optional #t ())
   (p_provability 3 optional #t ())
   (plus_explicit_prop 1 optional #t ())
   (true_upto_n__true_everywhere
    4
    optional
    #f
    (b_16_atmpt_1 b_16_atmpt_2 b_16_atmpt_3))
   (palindromes 4 recommended #t ())
   (palindrome_converse 5 optional #t ())
   (subsequence 4 #f #t ())
   (foo_ind_principle 2 optional #t ())
   (bar_ind_principle 2 optional #t ())
   (no_longer_than_ind 2 optional #t ())
   (R_provability 2 optional #t ())))
 (Logic
  ((proj2 1 optional #f (proj2))
   ...
   (True_induction 2 optional #t ())
   (double_neg_inf 2 recommended #t ())
   ...
   (total_relation 2 recommended #t ())
   (empty_relation 2 #f #t ())
   (R_provability 3 recommended #t ())
   (R_fact 3 optional #t ())
   (all_forallb 3 recommended #t ())
