((Basics
 ...
 (Imp
  ((optimize_0plus_b 3 #f #t (optimize_0plus_b))
   (optimizer 4 optional #t (optimizer))
   (bevalR 3 #f #t (bevalR))
   ...
   (XtimesYinZ_spec 3 recommended #t (XtimesYinZ_spec))
   (loop_never_stops 3 recommended #f (loop_never_stops))
   (no_whilesR 3 optional #t (no_whilesR no_whiles_eqv))
   (no_whiles_terminating 4 optional #t (no_whiles_terminating))
   (subtract_slowly_spec 4 optional #t (subtract_slowly_spec))
   (add_for_loop 4 optional #t (add_for_loop))
   (short_circuit 3 optional #t (short_circuit))
   (stack_compiler
    4
    recommended
    #f
 ...
 (Equiv
  ((pairs_equiv 2 optional #t (pairs_equiv))
   ...
   (WHILE_false_informal 2 #f #t (WHILE_false_informal))
   (WHILE_true_nonterm_informal 2 optional #t (WHILE_true_nonterm_informal))
   (WHILE_true 2 recommended #f (WHILE_true))
   (seq_assoc 2 optional #f (seq_assoc))
   (assign_aequiv 2 recommended #f (assign_aequiv))
   (functional_extensionality_failed_false
    2
    optional
    #t
    (functional_extensionality_failed_false))
   ...
   (optimize_0plus 4 optional #t (optimize_0plus))
   (better_subst_equiv 4 optional #t (better_subst_equiv aeval_weakening))
   ...
   (for_while_equiv 4 optional #t (for_while_equiv))
   (swap_noninterfering_assignments
    ...
    (swap_noninterfering_assignments))))
 (Hoare
  ((assertions 1 #f #t (assertions))
   (triples 1 #f #t (triples))
   (valid_triples 1 #f #t (valid_triples))
   (wp 1 #f #t (wp))
   (is_wp_formal 3 optional #f (is_wp_example))
   (hoare_asgn_examples 2 #f #t (hoare_asgn_examples))
   (hoare_asgn_wrong 2 #f #t (hoare_asgn_wrong))
   (hoare_asgn_fwd 3 optional #f (hoare_asgn_fwd))
   (hoare_asgn_weakest 2 #f #f (hoare_asgn_weakest silly1 silly2))
   (hoare_asgn_examples_2 2 #f #t (hoare_asgn_examples_2))
   ...
   (add_slowly_decoration 3 #f #t (add_slowly_decoration))
   (add_slowly_formal 3 #f #t (add_slowly_formal))
   (wrong_find_parity_invariant 2 #f #t (wrong_find_parity_invariant))
   (sqrt_informal 3 #f #t (sqrt_informal))
   (fact_informal 3 optional #t (fact_informal))
   ...
   (factorial_dec 4 optional #t (factorial_dec))))
 (Rel
  ((total_relation 2 optional #t (total_relation))
   (empty_relation 2 optional #t (empty_relation))
   (|lt_trans'| 2 optional #f (|lt_trans'|))
   (|lt_trans''| 2 optional #f (|lt_trans''|))
   (le_S_n 1 optional #f (le_S_n))
   (le_Sn_n_inf 2 optional #t (le_Sn_n_inf))
   (le_Sn_n 1 optional #f (le_Sn_n))
   (le_not_symmetric 2 optional #f (le_not_symmetric))
   (le_antisymmetric 2 optional #f (le_antisymmetric))
 ...
 (Smallstep
  ((test_step_2 2 #f #f (test_step_2))
   ...
   (eval__multistep_inf 3 #f #t (eval__multistep_inf))
   (step__eval 3 #f #f (step__eval))
   (multistep__eval 3 #f #f (multistep__eval))
   (combined_properties 4 #f #t (combined_properties))
   (par_body_n__Sn 3 optional #f (par_body_n__Sn))
   (par_body_N 3 optional #f (par_body_n))))
 (Types
  ((normalize_ex 1 #f #f (normalize_ex))
   ...
   (finish_progress_informal 3 recommended #t (finish_progress_informal))
   (finish_progress 3 #f #f (progress))
   (step_review 1 #f #t (step_review))
   (finish_preservation_informal
    3
    recommended
    #t
    (finish_preservation_informal))
   ...
   (subject_expansion 2 recommended #t (subject_expansion))
   (variation1 2 #f #t (variation1))
   (variation2 2 #f #t (variation2))
   (variation3 2 #f #t (variation3))
   (variation4 2 #f #t (variation4))
   (variation5 2 #f #t (variation5))
   (variation6 2 #f #t (variation6))
   (variation7 2 #f #t (variation7))
   (variation8 2 #f #t (variation8))
   (more_variations 3 optional #t (more_variations))
   (remove_predzero 1 #f #t (remove_predzero))
   (prog_pres_bigstep 4 optional #t (prog_pres_bigstep))))
 (Stlc
  ((step_example3 2 #f #t (step_example3))
   ...
   (typing_statements 1 optional #t (typing_statements))
   (more_typing_statements 1 #f #t (more_typing_statements))
   (progress_from_term_ind 3 optional #f (|progress'|))
   (typable_empty__closed 2 #f #f (typable_empty__closed))
   (subject_expansion_stlc 2 recommended #t (subject_expansion_stlc))
   (type_soundness 2 optional #f (soundness))
   (types_unique 3 #f #t (types_unique))
   (progress_preservation_statement 1 #f #t (progress_preservation_statement))
   (stlc_variation1 2 #f #t (stlc_variation1))
   (stlc_variation2 2 #f #t (stlc_variation2))
   (stlc_variation3 2 #f #t (stlc_variation3))
   (stlc_variation4 2 #f #t (stlc_variation4))
   (stlc_variation5 2 #f #t (stlc_variation5))
   (stlc_variation6 2 #f #t (stlc_variation6))
   (stlc_variation7 2 #f #t (stlc_variation7))
   (stlc_arith 4 optional #t (stlc_arith))))
 (MoreStlc
  ((halve_fix 1 #f #t (halve_fix))
   (fact_steps 1 recommended #t (fact_steps))
   (STLC_extensions 4 recommended #t (STLC_extensions)))))
